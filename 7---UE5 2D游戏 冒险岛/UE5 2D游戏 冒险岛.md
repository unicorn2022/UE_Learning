...
3.   双击蓝图类**BP_Player_Serena**，进入蓝图编辑器
     1.   设置角色：修改**Sprite|细节|精灵|源图像序列视图**为**FB_Idle**
     2.   添加Camera：先添加组件**SpringArm(弹簧臂组件)**，然后添加组件**Camera(摄像机组件)**，作为**SpringArm**的子组件
     3.   旋转**弹簧臂**，让摄像机正对角色
     4.   修改**摄像机|细节|摄像机设置|投射模式**为**正交**，**正交宽度**为1304
          1.   正交宽度越大，距离角色越远
     5.   修改胶囊体组件的半高，使之恰好包含角色
